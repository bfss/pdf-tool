...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_3.addWidget(self.pushButton_ok, 2, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("Form", u"\u6587\u4ef6\u5217\u8868", None))
